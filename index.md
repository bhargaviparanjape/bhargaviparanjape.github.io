...
I have an MS in Language Technology from [LTI](https://www.lti.cs.cmu.edu/), CMU and a B.Tech in Computer Science and Engineering from [IIT Kharagpur](http://cse.iitkgp.ac.in/){:target="_blank" rel="noopener"}.
